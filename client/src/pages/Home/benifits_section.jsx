    ...
    <section className="benefits_section p-2 md:p-8 sm:py-20 lg:py-24 ">
      <div className=" max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
          ...
          <div className="md:col-span-2 md:row-span-2 bg-gradient-to-br from-[var(--sancga)] to-[var(--sancgb)] rounded-3xl p-6 sm:p-8 shadow-sm hover:shadow-md hover:scale-[1.02] transition-all">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white/80 rounded-2xl flex items-center justify-center shadow-sm">
                <Droplets className="w-6 h-6 sm:w-7 sm:h-7 text-[#027c68]" />
              </div>
              <h3 className="text-2xl sm:text-3xl font-bold text-[var(--main-white)]">
                Automatic Irrigation
              </h3>
            </div>
            ...
            <div className="bg-[var(--main-white)] rounded-2xl p-5 sm:p-6">
              <div className="flex items-baseline gap-2 mb-2">
                  <span className="text-5xl sm:text-6xl font-bold text-[#027c68]">Less</span>
                  <span className="text-lg sm:text-xl font-semibold text-[var(--metal-dark2)]">
                    Manual Labor
                  </span>
              </div>
             <p className="text-sm text-[var(--metal-dark2)]">
              Traditional manual spraying is time-consuming and inconsistent. SproutSync automates irrigation, freeing up time and eliminating the guesswork of watering by hand.
            </p>
            </div>
          </div>

          {/* Water Level Safety */}
          <div className="md:col-span-2 bg-gradient-to-r from-[var(--white-blple)] via-[var(--white-blple)] to-[var(--white-blple)] rounded-3xl p-6 shadow-sm hover:shadow-md hover:scale-[1.02] transition-all">
          ...
          {/* Real-Time Alerts */}
          <div className="bg-gradient-to-br from-[#A8C7B8] to-[#C4DED0] rounded-3xl p-6 shadow-sm hover:shadow-md hover:scale-[1.02] transition-all">
            <div className="w-12 h-12 bg-white/80 rounded-xl flex items-center justify-center shadow-sm mb-4">
            ...
            <p className="text-sm text-[var(--metal-dark2)]">
              Receive timely alerts when your water supply is running low
            </p>
          </div>

          {/* Data Logging */}
          <div className="md:col-span-2 bg-gradient-to-br from-[#b7efc5] to-[#7BA591] rounded-3xl p-6 shadow-sm hover:shadow-md hover:scale-[1.02] transition-all">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-12 h-12 bg-white/80 rounded-xl flex items-center justify-center shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:col-start-3 md:col-end-5 md:row-start-3">
            {[
              ...
              <div key={i} className="bg-[var(--main-white)] rounded-3xl p-6 shadow-sm border border-[#E8F3ED] hover:shadow-md hover:scale-[1.02] transition-all">
